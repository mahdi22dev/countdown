...
const All = ({ data, session }) => {
  ...
  return (
    <section className='w-full p-5 max-w-[90rem]'>
      <div className=' h-20 mb-2 flex justify-between mx-auto items-end gap-2 '>
      ...
      {/* display movies */}
      <div className='w-full flex justify-center items-center cursor-pointer mx-auto bg-base-100 border border-primary p-1 rounded-md -z-0  '>
